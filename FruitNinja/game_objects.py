...
def load_images():
    ...
    katana_frames = []
    for i in range(6):
        p1 = f"frutas/katana/katana{i}.png"     # katana0.png..katana5.png
        p2 = f"frutas/katana/katana{i:02d}.png" # katana00.png..katana05.png

        img = load(p1, size=(90, 90))
        if img is None:
            img = load(p2, size=(90, 90))
